...
export default function InvestmentsPage() {
  ...
  const [userBalance, setUserBalance] = useState(25000) // Mock user balance
  ...
  const handleInvestmentAllocation = async (amount: number) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setUserBalance(prev => prev - amount) // Update balance
      } else {
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        >
          <div className="flex items-center justify-center mb-4">
            <div className="p-3 bg-gradient-to-r from-blue-500/20 to-purple-500/20 rounded-full backdrop-blur-sm border border-white/10">
          ...
          <p className="text-xl text-white/70 max-w-3xl mx-auto leading-relaxed">
            Experience the most powerful trading agent ever deployed publicly. 
            Our AI-driven investment strategies combine cutting-edge technology with proven risk management.
          </p>
        ...
        {/* Investment Allocation Flow Modal */}
        {selectedPlan && (
