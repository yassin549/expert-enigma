  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#03040e] text-white">
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <div className="container mx-auto px-4 py-8 pb-16 flex-1 w-full">
        {/* Account Summary */}
        <motion.div
...
<div className="container mx-auto px-4 py-8 pb-16 flex-1 w-full bg-[#151a30] rounded-2xl shadow-[0_15px_40px_rgba(15,23,42,0.45)]">
  {/* Account Summary */}
  <motion.div
    initial={{ opacity: 0, y: 20 }}
    animate={{ opacity: 1, y: 0 }}
