...
export default function WithdrawPage() {
  ...
  const [depositedAmount] = useState(500) // Mock deposited amount
  ...
  const confirmWithdrawal = () => {
    // Here would be the actual withdrawal request logic
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-white font-bold text-lg">Withdraw Funds</span>
              </div>
            </div>
            
            <div className="flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-md rounded-full border border-white/20">
              <Shield className="w-4 h-4 text-green-400" />
              <span className="text-sm text-white/90">Exceptional Service</span>
            </div>
          </div>
        </nav>
      </header>
